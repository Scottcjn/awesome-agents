...
- [AffixIO](https://www.npmjs.com/package/affixio) - Node SDK that gives a host a signed yes/no before an agent pays or calls a tool (Know Your Agent / x402BeforePay; not person KYC).
