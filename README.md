...
- [Base toolbox](https://basetoolbox.cartonpliant.workers.dev) - Paid Uniswap v3 swap preflight, leftover allowances, tx explain, and transfer check on Base via x402 USDC. GET `/v1/constants` is free.
