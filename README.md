...
- [Sinatra](https://sinatra.dev) - Coding agent that turns Linear and GitHub issues into pull requests, running in an isolated sandbox on your own Claude or ChatGPT subscription.
